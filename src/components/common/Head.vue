...
<!--      <i class="el-icon-s-home" v-on:click="login"></i>-->
    ...
    <div class="header-right">
      ...
      <div class="header-user-con">
        <el-button v-if="this.$store.state.users.type==1 ||this.$store.state.users.type==3" type="success" round v-on:click="openall">一键开阀</el-button>
        <el-button v-if="this.$store.state.users.type==1 ||this.$store.state.users.type==3" type="danger" round v-on:click="closeall">一键关阀</el-button>
        <!--        用户头像-->
